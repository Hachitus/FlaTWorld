  ...
  function setupMapMovement() {
    ...
    return {
      ...
      _testObject: {
        ...
        viewportWorkerOnMessage: viewportWorkerOnMessage,
    ...
    function check() {
      ...
      var viewportFn = setupHandleViewportArea();
    ...
    function viewportWorkerOnMessage(scaledViewport, primaryLayers) {
      ...
      promises = window.Q.all(promises).then(function () {
        ...
        promises = subcontainers.map(function (thesesContainers) {
          ...
          window.setTimeout(function () {
            thesesContainers.forEach(function (thisContainer) {
    ...
    function getViewportWithOffset(viewportArea) {
      var options = arguments.length <= 1 || arguments[1] === undefined ? { scale: 1 } : arguments[1];
