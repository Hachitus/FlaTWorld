...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e};!function(){function e(e,a){var c=arguments.length<=2||void 0===arguments[2]?{}:arguments[2],d=c.trackFPSCB,p=void 0===d?!1:d,s=c.isHiddenByDefault,y=void 0===s?!0:s,f=c.cache,m=void 0===f?!1:f,l=c.minimapCanvas,h=c.scaleMode,u=void 0===h?t.SCALE_MODES.DEFAULT:h;i.debug("============== Hexagonal Map factory started =============");var w=o.environmentDetection.getPixelRatio(),b="string"==typeof a.map?JSON.parse(a.map):a.map,g="string"==typeof a.type?JSON.parse(a.type):a.type,S="string"==typeof a.game?JSON.parse(a.game):a.game,v=("string"==typeof a.graphic?JSON.parse(a.graphic):a.graphic,o.resize.getWindowSize()),D={ObjectTerrain:n.objects.ObjectHexaTerrain,ObjectUnit:n.objects.ObjectHexaUnit},O={mapSize:S.mapSize,bounds:{x:0,y:0,width:v.x,height:v.y},rendererOptions:{resolution:w,autoResize:!0,transparent:!0,antialias:!1},subcontainers:{width:500,height:500,maxDetectionOffset:100,isHiddenByDefault:y},trackFPSCB:p,cache:m,defaultScaleMode:u,minimapCanvas:l},x=new r(e,O);return t.SCALE_MODES.DEFAULT=1,b.layers.forEach(function(e){if("object"!==("undefined"==typeof e?"undefined":_typeof(e)))throw i.error("Problem in hexaFactory, with layerData:"+JSON.stringify(e)),new Error("Problem in hexaFactory, with layerData:",e);var a,r=x.getRenderer(),o={name:e.name,coord:e.coord,drawOutsideViewport:{x:r.width,y:r.height},selectable:"unitLayer"===e.name};try{a=x.addLayer(o),e.objectGroups.forEach(function(e){var r=e.typeImageData;return r?void e.objects.forEach(function(o){var n,c,d,p;try{if(n=g.objectData[r][o.objType],!n)throw i.error("Bad mapData for type:",r,o.objType,o.name),new Error("Bad mapData for type:",r,o.objType,o.name);d=t.Texture.fromFrame(n.image),c={data:{typeData:n,activeData:o.data},radius:S.hexagonRadius,minimapColor:n.minimapColor,minimapSize:n.minimapSize},p=new D[e.type](d,o.coord,c),a.addChild(p)}catch(s){i.error(s)}}):void i.error("Error with spritesheetType-data")})}catch(n){i.error("Problem:"+JSON.stringify(e.type)+" ---- "+JSON.stringify(n.stack))}}),x.moveMap(S.startPoint),x}var t=window.flatworld_libraries.PIXI,a=window.flatworld,r=a.Flatworld,o=a.utils,i=a.log,n=window.flatworld.extensions.hexagons;window.flatworld.factories.hexaFactory=e}();